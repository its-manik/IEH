...
function Appbar(props: Props) {
  return (
    <div className="appbar h-full">
      <header className="flex items-center justify-between h-full px-8 py-1 shadow-md w-dvw sticky top-0 bg-white">


        {/* <!-- Atkins Logo  --> */}

        <div>
          <AtkinsLogo  width={35} height={35}/>
        </div>

        {/* <!-- IEH Logo --> */}

        <div className="flex flex-row flex-nowrap items-center gap-2">
          <IEHLogo width={40} height={40} />
          <h1 className="text-xl hidden md:block">Information Exchange Hub</h1>
        </div>
