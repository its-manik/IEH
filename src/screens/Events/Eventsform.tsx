      ...
      <ModalHeader className="border-0">
        <div className="flex flex-col">
          ...
          <div className="text-sm mt-1 font-light text-sysNeutral-800">
            {isNew
              ? "Let's create and configure your event in the easiest possible way"
            ...
            <ModalBody className="overflow-visible">
              <div className="flex flex-col space-y-4">
                <FloatingLabel
                  ...
                  variant="outlined"
                  label="Event name"
                  helperText="Enter a descriptive name for your event (200 characters max)"
                  value={values.name}
                ...
                <FloatingLabel
                  ...
                  variant="outlined"
                  label="Description"
                  helperText="Enter a description for your event (500 characters max)"
            ...
            <ModalFooter className="border-0 float-right mt-20">
              ...
              <button
                ...
                disabled={
                  ...
                  (!isNew && deepEqual(initialValues, values))
                }
              >
                {isNew ? "Create" : "Save"}
              </button>
