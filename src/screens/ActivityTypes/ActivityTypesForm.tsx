      ...
      <ModalHeader className="border-0">
        <div className="flex flex-col">
          <div className="text-2xl">
            {isNew ? `Create ${formTexts.formTitle}` : `Edit ${formTexts.FormTitlf}`}
          </div>
          <div className="text-sm mt-1 font-light text-sysNeutral-800">
            {isNew
              ? formTexts.formSub
              : `Edit your ${formTexts.formTitle} details`}
          </div>
        </div>
      </ModalHeader>
      <Formik
            ...
            <ModalBody className="overflow-visible">
              <div className="flex flex-col space-y-4">
                <FloatingLabel
                  name="name"
                  variant="outlined"
                  label={`${formTexts.formTitle} Name`}
                  helperText={formTexts.helperText}
                  value={values.name}
                ...
                <FloatingLabel
                  ...
                  variant="outlined"
                  label="Description"
                  helperText={formTexts.helperTextDescription}
