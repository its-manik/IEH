      ...
      <ModalHeader className="border-0">
        <div className="flex flex-col">
          <div className="text-2xl">
            {isNew ? "Create Activity Type" : "Edit Activity Type"}
          </div>
            ...
            <ModalBody>
              <div className="flex flex-col space-y-4">
                <FloatingLabel
                  ...
                  helperText="Enter a descriptive name for your activity type (200 characters max)"
                  value={values.name}
                ...
                <FloatingLabel
                  ...
                  variant="outlined"
                  label="Description"
                  helperText="Enter a description for your activity type (500 characters max)"
